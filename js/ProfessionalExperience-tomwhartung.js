...
ProfessionalExperience.LodoSoftwareD3 = Object.create( ProfessionalExperience.MinimalJob, {
	...
	moreItems: { value:
		...
		'<li>Implemented all aspects of the Financial Goals feature by designing and ' +
			'creating the tables, writing and debugging the services, and creating and ' +
			'enhancing the User Interface.</li>' +
		'<li>Developed parts of the Administration User Interface of the D3 Banking product, ' +
			'using CoffeeScript, Backbone, jQuery, Underscore, and Node.' +
		'</li>' +
		'<li>Ported, integrated, maintained, and enhanced legacy Java code that uses the Cash '+
			'Edge Aggregation API to update the database with user account and transaction data.' +
		'</li>' +
		'<li>Used Java to write automated JUnit tests for the online banking user interface. ' +
		'</li>' +
		'<li>Wrote programs using the Selenium WebDriver Java API to find and ' +
			'manipulate HTML elements in web pages built using responsive design techniques.  ' +
			'Used Eclipse to run the tests in Firefox, Chrome, and ' +
			'versions 8, 9 and 10 of Internet Explorer.</li>' +
		'<li>Created virtual machines to allow running the automated tests on Windows 7 and ' +
			'Windows XP to support testing on versions 7, 8, 9, and 10 of Internet Explorer.  ' +
			'Wrote functional test cases.</li>' +
		'<li>Used Java and Flex to develop the External Institution Request feature, allowing ' +
			'users to request that a financial institution be added to the list of ' +
			'institutions that are aggregated.</li>' +
		'<li>Maintained and enhanced OCF, an online application allowing users to aggregate accounts, ' +
			...
			'Ant, and Freemarker Template.</li>' +
...
ProfessionalExperience.ConsultnetTlc = Object.create( ProfessionalExperience.MinimalJob, {
	...
	listItems: { value:
		...
		'<li>Wrote and ran performance and unit tests using SOAP-UI and JUnit, and profiled ' +
			'application with YourKit.</li>'
	},
	moreItems: { value:
		'<li>For ' +
			'<a href="http://www.tlcdelivers.com" title="Opens link in separate window" target="_blank">' +
